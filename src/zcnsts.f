...
*     A. Tanikawa adds this variables
      real*8 zeta
...
*
      if(z.lt.0.0001) then
         ...
         z = 0.0001
!         call initializeConvectiveCore(zeta)
      endif
!      if(.true. .and. ((0.00019 .lt. z .and. z .lt.  0.0021))) then
!      if(.false. .and. ((0.00019 .lt. z .and. z .lt.  0.0021))) then
      if(NewStarModel .and. ((0.00019.lt.z .and. z.lt.0.0021))) then
     ...
     &        .or. (0.0019 .lt. z .and. z .lt. 0.0021)) then
         ...
         call setMetallicity(zeta)
!         call initializeConvectiveCore(zeta)
!         write(0,*) 'Caution: This is Tanikawa FFs.'
      endif
*
*
*       ------------------------------------------------------------
