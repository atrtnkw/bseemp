* Tanikawa modifise the following functions in this file.
* thookf, tbgbf, tHef
* lzamsf, ltmsf, lhookf, lalphf, lbetaf, lHeIf, lbagbf
* rzamsf, rtmsf, rhookf, ralphf, rbetaf, rgammf, rminf, ragbf
* mcheif, mcagbf
***
