...
*
      ...
      READ(22,*)ifflag,wdflag,bhflag,nsflag,psflag,mxns
      read(22,*)NewStarModel,WindEnhanced,RadiusShrinkage
...
! 99   FORMAT(8f12.6,1p,e12.4,0p,f12.4,1p,e12.4)
 99   FORMAT(8f14.6,1p,e14.4,0p,f12.4,1p,2e12.4)
*
...
*
 ...
 50   j = j + 1
      ...
      goto 50
 60   continue
 100  format(a30,' Time ',f10.1,' Mass ',f9.3)
      WRITE(*,*)
*
************************************************************************
*
